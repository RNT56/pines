...
- Pine pins `RNT56/mlx-swift` and `RNT56/mlx-swift-lm` to exact TurboQuant fork revisions. These are the currently reachable Schtack-maintained forks from this environment.
