...
Last full cross-provider review: 2026-05-19. OpenRouter implementation and documentation refreshed: 2026-07-13.
...
- Privacy-minimized OpenRouter receipts that persist and display the resolved provider/model, fallback attempt chain, request strategy/region, token counts, BYOK state, and reported/upstream cost after the terminal stream chunk.
