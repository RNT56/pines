...
- Chat attachments are stored as local files. If cloud execution is selected, supported image, PDF, or text attachments can be encoded into the provider request for that turn.
